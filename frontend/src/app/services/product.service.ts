...
export class ProductService {
  ...
  // Obtener productos por usuario (usando contacto como identificador)
  getProductsByUser(userContact: string): Observable<Product[]> {
    return this.http.get<Product[]>(`${this.API_URI}/products/user/${userContact}`);
  }
}